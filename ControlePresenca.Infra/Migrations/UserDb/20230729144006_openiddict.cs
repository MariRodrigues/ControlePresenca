    ...
    public partial class openiddict : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "varchar(256)", nullable: false),
                    ApplicationId = table.Column<string>(type: "varchar(256)", nullable: true),
                    ConcurrencyToken = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(256)", nullable: false),
                    ApplicationId = table.Column<string>(type: "varchar(256)", nullable: true),
                    AuthorizationId = table.Column<string>(type: "varchar(256)", nullable: true),
                    ConcurrencyToken = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    CreationDate = table.Column<DateTime>(type: "datetime", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 99999, "c0b9f5b5-adcb-4c37-9bb7-5b9c22ea8a60", "admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 88888, "6dc25f0a-994d-44dc-8acd-ed1ae41f2b14", "user", "USER" });
